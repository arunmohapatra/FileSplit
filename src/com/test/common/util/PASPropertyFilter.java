//**************************************************************
//  Copyright (c) 2014-2015 by Progress Software Corporation
...
public class PASPropertyFilter implements PropertyManager.IPropertyValueFilter
{
   private Map<String,Object> pasProperties = null;
   // constructor to create an instance of Environment.
   public PASPropertyFilter(Map<String,Object> props)
   {
    Env = new Environment();
    m_propMgr = null;
    pasProperties = props;
   ...
   public PASPropertyFilter(PropertyManager p ,Map<String,Object> props)
   {
    Env = new Environment();
    m_propMgr = p;
    pasProperties = props;
   }
   private String parseProperty(String propertyVal){
	   if(propertyVal != null)
   ...
   public String filterValue(final String groupName, final String propertyName, String value)
   {
        ...
        if (OSInfo.IS_WINDOWS)
        {
            ...
            while (i >= 0)
            {
                ...
                if (currValue == null){
                	propName = newValue.substring(i+2, end);
                	currValue = parseProperty((String) pasProperties.get(propName));
                	if(currValue == null)
                		currValue = "";
                }
                newValue = newValue.substring(0,i) +
